...
export SIMULATOR_FRONTEND_TAG=twendt_fixes
...
export REFBOX_ARGS=" --cfg-mps mps/mqtt_new_mps.yaml --cfg-mongodb mongodb/enable_mongodb.yaml --cfg-comm comm/default_comm.yaml --cfg-team team/default_team.yaml --cfg-game game/labcegor_game.yaml"
